...
namespace MVCInjectionDependecy.Core.Models
{
    public partial class AdventureWorksLT2019Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=AdventureWorksLT2019;Persist Security Info=True;User ID=sa;Password=Willis2021;MultipleActiveResultSets=True;Application Name=EntityFramework");
            }
        }
